...
namespace Causal\Theodia\Xclass\V10\Backend\Form\FormDataProvider;
...
class SiteTcaInline extends \TYPO3\CMS\Backend\Form\FormDataProvider\SiteTcaInline
{
    ...
    public function addData(array $result): array
    {
        ...
        foreach ($result['processedTca']['columns'] as $fieldName => $fieldConfig) {
            ...
            if (!in_array($childTableName, ['site_errorhandling', 'site_language', 'site_route', 'site_base_variant', 'site_theodia_calendar'], true)) {
